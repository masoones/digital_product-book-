...
class Gateway(models.Model):
    ...
    descriptions = models.TextField('descriptions', blank=True)
...
class Payment(models.Model):
    ...
    STATUS_TRANSLATIONS={
        ...
        STATUS_PAID:'Payment succsessful.',
    ...
    device_uuid = models.CharField('device uuid', max_length=50, blank=True)
    token = models.CharField(max_length=100)
    phone_number = models.BigIntegerField('phone number', validators=[validate_phone_number], db_index=True)
    comsumed_code = models.PositiveIntegerField('consumed reference code', null=True, db_index=True)
